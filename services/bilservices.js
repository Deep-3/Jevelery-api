...
exports.getPurchaseBill = async (client_id,res) => {
    try {
...
reportData.forEach(reportData => {
  ...
  console.log(total_amount)
    return exportToPDF(res, reportData,total_amount, 'purchase_bill.hbs', 'purchase_report.pdf',purchaseorders.rows[0].purchase.client.email);
...
exports.getSaleBil = async (client_id, res) => {
    try {
...
reportData.forEach(reportData => {
    ...
    return exportToPDF(res, reportData,total_amount,'sales_bill.hbs','sales_report.pdf',salesorders.rows[0].sales.client.email);
